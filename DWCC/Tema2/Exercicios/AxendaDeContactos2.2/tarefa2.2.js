...
function modificarContacto(){
    ...
    if (contactoBuscado) {
        ...
        contactoBuscado.nome = nome.value;
        contactoBuscado.apelidos = apelidos.value;
        contactoBuscado.telefono = telefono.value;
        contactoBuscado.email = email.value;
        contactoBuscado.enderezo = enderezo.value;
...
function eliminarContacto() {
    //Coger elemento de html
    let contactoA_Eliminar = document.getElementById('nome').value.toLowerCase();
    //Borrar datos
    delete listaContactos[listaContactos.findIndex((contacto) => contacto.nome.toLowerCase() == contactoA_Eliminar)];
    actualizarContactos(listaContactos);
}