    ...
    <div class="container mt-5">
        <div class="card shadow-lg p-4">
            ...
            <a href="<?php echo e(route('entrenadores')); ?>" class="btn btn-outline-primary btn-lg fw-bold mt-3">⬅
                Volver</a>
            <form action="<?php echo e(route('entrenador.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.contenido', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lara/Proxecto_Final_Bruno_Couceiro_Sande/resources/views/nuevoEntrenador.blade.php ENDPATH**/ ?>