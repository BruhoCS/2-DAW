            ...
            <form action="<?php echo e(route('entreno.update', $entreno->id)); ?>" method="POST">
                ...
                <select name="id_user" id="id_user" class="form-select">
                    ...
                    <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($usuario->id); ?>" 
                            <?php echo e(old('usuario', isset($usuario) ? $usuario->id : '') == $usuario->id ? 'selected' : ''); ?>>
                ...
                <div class="mb-3">
                    ...
                    <select name="dia" id="escribirDia" class="form-select">
                        ...
                        <option value="Miércoles" <?php echo e(old('dia', $entreno->dia) == 'Miércoles' ? 'selected' : ''); ?>>
                            Miércoles</option>
                        ...
                        <option value="Viernes" <?php echo e(old('dia', $entreno->dia) == 'Viernes' ? 'selected' : ''); ?>>
                            Viernes</option>
                        <option value="Sábado" <?php echo e(old('dia', $entreno->dia) == 'Sábado' ? 'selected' : ''); ?>>Sábado
                        </option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <select name="descanso" id="descanso" class="form-select">
                        <option value="">Selecciona</option>
                        <option value="1min" <?php echo e(old('descanso', $entreno->descanso) == '1min' ? 'selected' : ''); ?>>1min
                        </option>
                        <option value="2min" <?php echo e(old('descanso', $entreno->descanso) == '2min' ? 'selected' : ''); ?>>2min
                        </option>
                        <option value="3min" <?php echo e(old('descanso', $entreno->descanso) == '3min' ? 'selected' : ''); ?>>3min
                        </option>
                        <option value="4min" <?php echo e(old('descanso', $entreno->descanso) == '4min' ? 'selected' : ''); ?>>4min
                        </option>
                        <option value="5min" <?php echo e(old('descanso', $entreno->descanso) == '5min' ? 'selected' : ''); ?>>5min
                        </option>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.contenido', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lara/Proxecto_Final_Bruno_Couceiro_Sande/resources/views/entreno.blade.php ENDPATH**/ ?>